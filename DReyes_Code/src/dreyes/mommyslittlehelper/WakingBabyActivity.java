...
public class WakingBabyActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_wakingbaby);
		currentTime = (TextView)findViewById(R.id.currentTimeWakingUp);
		
		changeTime = (Button)findViewById(R.id.changeTimeWakingUp);
		...
		submit = (Button)findViewById(R.id.wakingBabySubmit);
	...
	private void createCalendarEvent()
	{
		...
		try {
			...
			intent.putExtra(Events.TITLE, "Baby Waking");
